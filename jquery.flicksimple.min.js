...
d(b.get(0)).width();else if(this.snap=="smallest"){var e=0;b.each(function(){var a=d(this).width();if(e>a||e==0)e=a});this.pageWidth=e}else this.pageWidth=isNaN(this.snap)?0:this.snap;this.pageLength=Math.ceil(a/this.pageWidth);if(d.isFunction(this.onResize))this.onResize();this.goTo(this.page);return this},touchstart:function(a){var b=this;b.startX=(b.touchable?event.changedTouches[0]:a).clientX;a=a.target.tagName==="A"?d(a.target):d(a.target).closest("a");if(a.length>0)b.anc=a;setTimeout(function(){if(b.anc){var a=
b.anc,e=d.data(a.get(0),"flickSimple.link");e&&(a.attr("href",e),setTimeout(function(){a&&a.attr("href","javascript:;")},200))}},600)},touchmove:function(a){(this.android||this.lock)&&a.preventDefault();this.anc=null;if(this.startX!==null)a=(this.touchable?a.originalEvent.touches[0]:a).clientX,this.nextX=(this.currentX||0)+(a-this.startX),this.android||!this.webkit?this.target.css({left:this.nextX+"px"}):this.target.css({webkitTransition:"none",webkitTransform:"translate3d("+this.nextX+"px,0,0)"}),
this.flickX=this.preX-a,this.preX=a},touchend:function(){if(this.startX!==null){this.startX=null;if(this.anc){if(d.isFunction(this.onClick))this.onClick(this.anc);var a=this.anc.get(0),b=d.data(a,"flickSimple.link"),a=d.data(a,"flickSimple.target");if(b)a&&a!=="_self"?(a==="_blank"&&(a=""),window.open(b,a)):location.href=b;return!1}b=this.nextX+this.flickX*-this.ratio;this.pageWidth&&(a=b%this.pageWidth,b-=a<-this.pageWidth/2?a+this.pageWidth:a);b>0?b=0:b<-this.elmWidth&&(b=-this.elmWidth);this.android||
!this.webkit?this.target.animate({left:b+"px"},this.duration,function(a,b,d,g,h){return-g*(b/=h)*(b-2)+d}):this.target.css({webkitTransition:"-webkit-transform "+this.duration/1E3+"s ease-out",webkitTransform:"translate3d("+b+"px,0,0)"});this.update(b)}},update:function(a){if(this.pageWidth)this.page=Math.ceil(a*-1/this.pageWidth)+1;if(this.currentX!==a&&(this.currentX=a,d.isFunction(this.onChange)))this.onChange();return this},no_mousedown:function(a){a.preventDefault()},init:function(){var a=this;
a.target.find("a").each(function(){var b=d(this),c=b.attr("href"),e=b.attr("target");c&&c!="javascript:;"?d.data(this,"flickSimple.link",c):d.data(this,"flickSimple.link","");d.data(this,"flickSimple.target",e||"");b.attr("href","javascript:;").removeAttr("target");a.touchable||b.unbind("mousedown",a.no_mousedown).bind("mousedown",a.no_mousedown)});a.touchable||a.target.find("img").unbind("mousedown",a.no_mousedown).bind("mousedown",a.no_mousedown);return a}});d.fn.flickSimple=function(a){var b=this;
